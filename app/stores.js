// 店舗一覧（多店舗展開のマスター）。名前はスプレッドシート『店舗受付』タブから転記。
// id:      内部ID（通知の絞り込みや非表示・フォルダ設定のキーに使う。後から変えない）
// name:    アイコンの下に出す名前（受付タブの「アイコン短縮名」）
...
window.SUSABIYU_STORES = [
  { id: "sanjo",        name: "三条店",           full: "すさび湯 河原町三条店",       short: "稼働中", icon: "icons/storelogo_tile.png", initial: "湯", url: "./index.html",    live: true },
  { id: "taishusushi",  name: "梅田本店",         full: "大衆寿司酒場すさび湯",         short: "", icon: "", initial: "湯", url: "./store.html?id=taishusushi", live: false },
  ...
  { id: "goldporta",    name: "GOLD京都ポルタ",   full: "GOLD京都ポルタ",               short: "", icon: "", initial: "G", url: "./store.html?id=goldporta", live: false },
  { id: "sannomiya",    name: "三宮店",           full: "すさび湯 三宮",                short: "", icon: "", initial: "湯", url: "./store.html?id=sannomiya", live: false },
  { id: "karasuma",     name: "京都烏丸",         full: "すさび湯 京都烏丸",            short: "", icon: "", initial: "鮨", url: "./karasuma.html", live: false },
  { id: "kadoma",       name: "門真Largo",        full: "門真Largo",                    short: "", icon: "", initial: "門", url: "./store.html?id=kadoma", live: false },
  { id: "temmabashi",   name: "天満橋店",         full: "すさび湯 天満橋",              short: "", icon: "", initial: "湯", url: "./store.html?id=temmabashi", live: false },
  { id: "goldohatsu",   name: "GOLDお初天神",     full: "フレンチ酒場GOLDお初",         short: "", icon: "", initial: "G", url: "./store.html?id=goldohatsu", live: false },
  { id: "gifuya",       name: "ぎふや 天満橋",    full: "ぎふや 天満橋店",              short: "", icon: "", initial: "ぎ", url: "./store.html?id=gifuya", live: false },
  { id: "shinjuku",     name: "新宿東口店",       full: "すさび湯 新宿東口",            short: "", icon: "", initial: "湯", url: "./store.html?id=shinjuku", live: false },
  { id: "kabukicho",    name: "歌舞伎町店",       full: "すさび湯 歌舞伎町",            short: "", icon: "", initial: "湯", url: "./store.html?id=kabukicho", live: false },
